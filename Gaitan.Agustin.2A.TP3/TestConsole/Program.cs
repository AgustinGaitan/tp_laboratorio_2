...
namespace TestConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Alumno.EEstadoCuenta.Becado); uni += a1; try
            {
            ...
            Alumno.EEstadoCuenta.Deudor); uni += a2;
            }
            ...
            Alumno.EEstadoCuenta.AlDia); uni += a8;

            Profesor i1 = new Profesor(1, "Juan", "Lopez", "12224458", EntidadesAbstractas.Persona.ENacionalidad.Argentino); uni += i1;
            Profesor i2 = new Profesor(2, "Roberto", "Juarez", "32234456", EntidadesAbstractas.Persona.ENacionalidad.Argentino); uni += i2; try
            {
